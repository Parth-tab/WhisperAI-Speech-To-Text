from PySide6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, 
                               QLineEdit, QPushButton, QTableWidget, QTableWidgetItem, QHeaderView, QComboBox)
...
class StyleEditor(QWidget):
    def __init__(self, config_manager, parent=None):
        ...
        self.table_widget.setHorizontalHeaderLabels(["Process Name (e.g. slack.exe)", "Style Profile"])
